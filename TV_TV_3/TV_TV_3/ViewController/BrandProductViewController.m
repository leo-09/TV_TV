...
@interface BrandProductViewController ()<UITableViewDelegate, UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        BrandProductCell *cell = [BrandProductCell cellWithTableView:tableView];
        return cell;
    } else {
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (section == 0) {
        ...
        NSArray *colors = @[(__bridge id)UIColorFromRGB(0xffbe00).CGColor,
                            (__bridge id)UIColorFromRGB(0xff5a09).CGColor];
        ...
        CGRect labelFrame = CGRectMake(15, 0, labelViewFrame.size.width-30, labelViewFrame.size.height);
