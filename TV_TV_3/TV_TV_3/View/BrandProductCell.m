...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    static NSString *identifier = @"BrandProductCell";
    // 1.缓存中
    BrandProductCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    // 2.创建
    if (cell == nil) {
        cell = [[BrandProductCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _nameLabel.text = @"全聚德烤鸭店全聚德烤鸭店全聚德烤鸭店";
        ...
        _storeLabel.text = @"诺金 望京南店";
        [_storeLabel setCustomFontWithBold:NO withSize:12 withTextColor:UIColorFromRGB(0xe0e0e0)];
        ...
        [_discountLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(_storeLabel.mas_top).offset(-10);
        }];
    }
