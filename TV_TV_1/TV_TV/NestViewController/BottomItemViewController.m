...
@interface BottomItemViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BottomItemViewController
...
- (void)insertRowAtTop {
    for (int i = 0; i < 10; i++) {
        [self.data insertObject:@(i) atIndex:0];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"1--%@", self.data[indexPath.row]];
