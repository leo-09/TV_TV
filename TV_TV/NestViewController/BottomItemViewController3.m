...
@interface BottomItemViewController3 ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BottomItemViewController3
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"3--%@", self.data[indexPath.row]];
